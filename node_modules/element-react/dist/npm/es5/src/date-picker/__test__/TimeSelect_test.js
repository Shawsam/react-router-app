...
describe('TimePicker test', function () {
  ...
  function mountDefault() {
    ...
    return (0, _enzyme.mount)(_react2.default.createElement(_TimeSelect2.default, _extends({}, minProps, props)));
  }
  ...
  it('should have valid state', function () {
    ...
    var w = (0, _enzyme.mount)(_react2.default.createElement(_TimeSelect2.default, _extends({}, minProps, {
      onChange: onChange
    })));
